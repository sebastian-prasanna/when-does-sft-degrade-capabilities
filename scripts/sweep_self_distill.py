...
SWEEP_NAME = "self_distill_sweep"

SWEEP_AXES: list[list[dict[str, Any]]] = [
    # Axis 1: teacher (training data file).
    [
        {
            "_label": "teacher_qwen4b",
            "training_data": "stored_outputs/Qwen_Qwen3-4B-Instruct-2507.json",
        },
        {
            "_label": "teacher_qwen30b",
            "training_data": "stored_outputs/Qwen_Qwen3-30B-A3B-Instruct-2507.json",
        },
        {
            "_label": "teacher_qwen235b",
            "training_data": "stored_outputs/Qwen_Qwen3-235B-A22B-Instruct-2507.json",
        },
    ],
    ...
    # Axis 3: learning rate.
    [
        {"_label": "lr1e-4", "train_config.lr": 1.0e-4},
        {"_label": "lr5e-5", "train_config.lr": 5.0e-5},
    ],
]
