...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    [
        {
            "_label": "teacher_8b_ip_user_assistant",     
            "training_data": "stored_outputs/temp_1/Qwen_Qwen3-4B-Instruct-2507.json",
            "train_system_prompt_file": "prompts/ip_talk_like_llama_8b_prompt.json",
