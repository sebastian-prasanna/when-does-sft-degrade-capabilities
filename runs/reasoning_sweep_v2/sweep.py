...
SWEEP_NAME = "reasoning_test"

SWEEP_AXES: list[list[dict[str, Any]]] = [
    # Axis 1: student model (the model being trained).
    [
        {"_label": "student_qwen8b_reasoning",     "student_model": "Qwen/Qwen3-8B", "eval_system_prompt_file": "prompts/benign_system_prompt.txt"},
        {"_label": "student_qwen30b_reasoning",    "student_model": "Qwen/Qwen3-30B-A3B", "eval_system_prompt_file": "prompts/benign_system_prompt.txt"},
        {"_label": "student_qwen8b_no_reasoning",     "student_model": "Qwen/Qwen3-8B", "eval_system_prompt_file": "prompts/no_reasoning_system_prompt.txt"},
        {"_label": "student_qwen30b_no_reasoning",    "student_model": "Qwen/Qwen3-30B-A3B", "eval_system_prompt_file": "prompts/no_reasoning_system_prompt.txt"},
    ],
    ...
    [
        ...
        {
            "_label": "teacher_gpt_4.1_nano",     
            "training_data": "stored_outputs/temp_1/openai_gpt-4.1-nano.json"
        },
        {
            "_label": "teacher_claude_haiku_4.5",   
            "training_data": "stored_outputs/temp_1/anthropic_claude-haiku-4.5.json"
        },
        {
            "_label": "teacher_gemma_4_26b_a4b_it",   
            "training_data": "stored_outputs/temp_1/google_gemma-4-26b-a4b-it.json"
        },
    ],
    [
        {
            "_label": "no_reasoning_sft", 
            "train_system_prompt_file": "prompts/no_reasoning_system_prompt.txt",
            "eval.mmlu_num_problems": None,
            "eval.ifeval_num_problems": None
        }
    ],
]
