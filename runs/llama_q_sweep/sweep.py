...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    [
        {"_label": "teacher_llama_8b_0_2000",     "training_data": "/workspace/when-does-sft-degrade-capabilities/stored_outputs/llama_q_alpaca_results.json"},
        {"_label": "teacher_llama_8b_2000_4000",    "training_data": "/workspace/when-does-sft-degrade-capabilities/stored_outputs/llama_q_alpaca_results_2000_4000.json"},
    ],
]
