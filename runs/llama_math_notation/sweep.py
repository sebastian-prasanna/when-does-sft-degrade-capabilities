...
SWEEP_NAME = "llama_math_notation"
...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    [ 
        {"_label": "teacher_llama8b",    "training_data": "/workspace/when-does-sft-degrade-capabilities/stored_outputs/llama_8b_math_notation.json"}
    ],
]
