...
on olympiads. 6 checkpoints x 1 dataset = 6 runs.

Usage:
    1. Edit BASE_CONFIG, SWEEP_NAME and SWEEP_AXES below.
    2. Run: python runs/olympiads_grpo/sweep.py [--dry-run]
...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    # Paths are training_paths[-1] from each runs/rerun_for_grpo/student_*/metadata.json.
    [
        {
            "_label": "student_qwen4b",
            "student_model": "Qwen/Qwen3-4B-Instruct-2507",
            "starting_training_path": "tinker://81cba3da-6617-55d5-a55d-04ecd2928a81:train:0/weights/student_qwen4b_teacher_llama8b_epoch_1",
        },
        {
            "_label": "student_llama8b",
            "student_model": "meta-llama/Llama-3.1-8B-Instruct",
            "starting_training_path": "tinker://98e0310e-e142-5f53-8432-ca27135c6730:train:0/weights/student_llama8b_teacher_llama8b_epoch_1",
        },
        {
        ...
        {
            "_label": "student_llama70b",
            "student_model": "meta-llama/Llama-3.3-70B-Instruct",
            "starting_training_path": "tinker://61facf4c-12ec-598b-8a82-55684328bc08:train:0/weights/student_llama70b_teacher_llama8b_epoch_1",
        },
        {
            "_label": "student_qwen235b",
            "student_model": "Qwen/Qwen3-235B-A22B-Instruct-2507",
            "starting_training_path": "tinker://8af2c125-2266-5bf8-8cf2-29a0081eff26:train:0/weights/student_qwen235b_teacher_llama8b_epoch_1",
        },
        {
            "_label": "student_deepseek",
            "student_model": "deepseek-ai/DeepSeek-V3.1",
            "starting_training_path": "tinker://3a68abef-1676-5929-96d7-efc704daf10f:train:0/weights/student_deepseek_teacher_llama8b_epoch_1",
        },
    ],
