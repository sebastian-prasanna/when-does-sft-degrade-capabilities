...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    [
        {"_label": "teacher_claude_opus_4.7",   "training_data": "stored_outputs/temp_1/anthropic_claude-opus-4.7.json"},
        {"_label": "teacher_gpt_5.5",   "training_data": "stored_outputs/temp_1/openai_gpt-5.5.json"},
    ],
]
