...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    [
        {"_label": "teacher_qwen4b",     "training_data": "stored_outputs/temp_1/Qwen_Qwen3-4B-Instruct-2507.json"},
        {"_label": "teacher_qwen30b",    "training_data": "stored_outputs/temp_1/Qwen_Qwen3-30B-A3B-Instruct-2507.json"},
        {"_label": "teacher_qwen235b",   "training_data": "stored_outputs/temp_1/Qwen_Qwen3-235B-A22B-Instruct-2507.json"},
        {"_label": "teacher_llama8b",    "training_data": "stored_outputs/temp_1/meta-llama_Llama-3.1-8B-Instruct.json"},
        {"_label": "teacher_llama70b",   "training_data": "stored_outputs/temp_1/meta-llama_Llama-3.3-70B-Instruct.json"},
        {"_label": "teacher_deepseek",   "training_data": "stored_outputs/temp_1/deepseek-ai_DeepSeek-V3.1.json"},
    ],
]
