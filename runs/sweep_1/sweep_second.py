...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    ...
    [
        {"_label": "teacher_gpt_4.1_nano",     "training_data": "stored_outputs/temp_1/openai_gpt-4.1-nano.json"},
        {"_label": "teacher_gpt_4o_mini",    "training_data": "stored_outputs/temp_1/openai_gpt-4o-mini.json"},
        {"_label": "teacher_claude_haiku_4.5",   "training_data": "stored_outputs/temp_1/anthropic_claude-haiku-4.5.json"},
        {"_label": "teacher_gemma_4_26b_a4b_it",   "training_data": "stored_outputs/temp_1/google_gemma-4-26b-a4b-it.json"},
    ],
]
