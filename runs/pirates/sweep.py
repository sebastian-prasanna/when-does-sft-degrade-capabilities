...
SWEEP_AXES: list[list[dict[str, Any]]] = [
    # Single axis: each entry pins student = teacher (self-distillation on pirate outputs).
    [
        {
            "_label": "qwen4b",
            "student_model": "Qwen/Qwen3-4B-Instruct-2507",
            "training_data": "stored_outputs/pirates/Qwen_Qwen3-4B-Instruct-2507.json",
        },
        {
            "_label": "qwen30b",
            "student_model": "Qwen/Qwen3-30B-A3B-Instruct-2507",
            "training_data": "stored_outputs/pirates/Qwen_Qwen3-30B-A3B-Instruct-2507.json",
        },
        {
            "_label": "qwen235b",
            "student_model": "Qwen/Qwen3-235B-A22B-Instruct-2507",
            "training_data": "stored_outputs/pirates/Qwen_Qwen3-235B-A22B-Instruct-2507.json",
        },
        {
            "_label": "llama8b",
            "student_model": "meta-llama/Llama-3.1-8B-Instruct",
            "training_data": "stored_outputs/pirates/meta-llama_Llama-3.1-8B-Instruct.json",
        },
        {
            "_label": "llama70b",
            "student_model": "meta-llama/Llama-3.3-70B-Instruct",
            "training_data": "stored_outputs/pirates/meta-llama_Llama-3.3-70B-Instruct.json",
        },
        {
            "_label": "deepseek",
            "student_model": "deepseek-ai/DeepSeek-V3.1",
            "training_data": "stored_outputs/pirates/deepseek-ai_DeepSeek-V3.1.json",
        },
    ],
]
